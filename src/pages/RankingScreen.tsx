        ...
        <div className="max-w-lg mx-auto pb-6">
          ...
          <div className="flex items-end justify-center px-4 pt-6 gap-2">
            {podiumOrder.map(idx => {
              ...
              const borderCol = idx === 0 ? 'border-amber-400/60' : idx === 1 ? 'border-gray-400/60' : 'border-amber-700/60';
              ...
              return (
                <motion.div key={idx} className="flex flex-col items-center gap-1.5 flex-1"
                  ...
                  {isFirst && <Crown size={22} className="text-amber-400 animate-float" />}
                  ...
                  <span className="text-[0.6rem] text-accent font-bold">{fmt(p.s)} pts</span>
